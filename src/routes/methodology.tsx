...
export const Route = createFileRoute("/methodology")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How Aequitas scores medical specialty compatibility: traits, meaning, opportunity, regret risk, and lifecycle modeling." },
      { property: "og:title", content: "Methodology — Aequitas" },
