...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Aequitas — Medical Specialty Identity Assessment" },
      { property: "og:description", content: "Find the medicine that fits your mind, life, and identity. A psychometric career compatibility engine for medical students and residents." },
