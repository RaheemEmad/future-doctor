...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Aequitas — Find the medical specialty that fits your mind, life, and identity." },
      ...
      { name: "twitter:title", content: "Aequitas — Find the medical specialty that fits your mind, life, and identity." },
